...
def inquiry(request):
    if request.method == 'POST':
        ...
        if request.user.is_authenticated:
            ...
            if has_contacted:
                messages.error(request, 'You have already made an inquiry about this car! Please wiat until we get back to you!')
        ...
        send_mail(
            'New Car Inquiry',
            'Yo have a new inquiry for the car '+ car_title + ', please login to your admin panel for more info.',
